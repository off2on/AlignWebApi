  ...
  var reset = function (el) {
    ...
    makeValid = function (el) {
      ...
      if (frmGroupEl) {
        ...
        if (addValidationStateIcons) {
          var iconElText = '<span class="form-control-feedback"></span>';
    ...
    makeInvalid = function (el, errorMsg) {
      ...
      if (frmGroupEl) {
        ...
        if (addValidationStateIcons) {
            var iconElText = '<span class="glyphicon glyphicon-alert form-control-feedback"></span>';
          if (inputGroupEl.length > 0) {
            iconElText = iconElText.replace('form-', '');
            iconElText = '<span class="input-group-addon control-feedback">' + iconElText + '</span>';
          }
...
angular.autoValidate.errorMessages['default'] = {
  ...
  pattern: 'Password should be atleast 8 characters long and should contain one number,one character and one special character',
  number: 'Please enter a valid number',
  url: 'Please enter a valid URL in the format of http(s)://www.google.com',
  passwordPattern: 'Password should be atleast 8 characters long and should contain one number,one character and one special character',
  phoneMask :'Please enter a valid phone number'
};
...
angular.module('jcs-autoValidate')
    ...
    function (defaultErrorMessageResolver) {
        ...
        defaultErrorMessageResolver.getErrorMessages().then(function (errorMessages) {
            ...
            errorMessages['userNameRequired'] = 'User Name is required';
            errorMessages['emailRequired'] = 'Email Address is required';
            errorMessages['passwordRequired'] = 'Password is required';
            errorMessages['URLRequired'] = 'URL is required';
            errorMessages['AccountTypeRequired'] = 'Account Type is required';
            errorMessages['AgreementRequired'] = 'Please check this box to proceed.';
